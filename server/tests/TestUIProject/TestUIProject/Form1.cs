    ...
    public partial class Form1 : Form
    {
        ...
        private void UI_Button_Connect_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                UI_Button_UpdateBrightness.Enabled = true;
                clientRx();
            }
        }
        ...
        {//build tx data with pipe header handling
            ...
            int payloadSize = pipeData.Length - HEADER_SIZE;
            byte[] voxelBytes = new byte[payloadSize];
            Buffer.BlockCopy(pipeData, HEADER_SIZE, voxelBytes, 0, payloadSize);

            UI_Textbox_Output.Text += $"Validated pipe message. frameCount={frameCount}, payloadBytes={payloadSize}\r\n";
            ...
            storedTxMessage = MessageHeader.Build3DImageMessage(
                voxelBytes,
                currentFramecount,
                currentSliceCount,
                dataType
        ...
        private async void UI_Button_UpdateSpeed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                msgHead.Brightness = (sbyte)WifiTxBrightness.Same;
                msgHead.PayloadCrc32 = 0;
        ...
        private async void UI_Button_UpdateBrightness_Click(object sender, EventArgs e)
        {
            //check if connection is alive
            if (socket == null || !socket.Connected)
            {
            ...
            try
            {
                ...
                msgHead.SliceCount = -1;
                msgHead.PayloadBytes = -1;
                msgHead.MotorSpeedRpm = (sbyte)WifiTxMotor.Same;

                if (UI_Num_Brightness.Value == 0)
                {
                    msgHead.Brightness = -1;
                }
                else {
                    msgHead.Brightness = (sbyte)UI_Num_Brightness.Value;
                }
